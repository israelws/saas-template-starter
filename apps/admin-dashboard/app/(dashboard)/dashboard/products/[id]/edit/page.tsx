...
import { Product, ProductVariant, ProductImage } from '@saas-template/shared';
...
interface ProductFormVariant extends ProductVariant {
  tempId?: string;
}
...
export default function EditProductPage() {
  ...
  const removeVariant = (tempId: string | undefined) => {
    if (tempId) {
          ...
          <TabsContent value="basic">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Update the basic information for the product</CardDescription>
              </CardHeader>
                        ...
                        {variants.map((variant) => (
                          ...
                          >
                              ...
                              {variant.attributes && Object.keys(variant.attributes).length > 0 && (
                                <div className="flex flex-wrap gap-2 mt-1">
                                  {Object.entries(variant.attributes).map(([key, value], index) => (
                                    <span
                                      key={`${variant.tempId || variant.id}-${key}-${index}`}
                            ...
                            <Button
                              ...
                              size="sm"
                              variant="ghost"
                              onClick={() => removeVariant(variant.tempId || variant.id)}
                            >
