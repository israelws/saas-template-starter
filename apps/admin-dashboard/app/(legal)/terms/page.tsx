    ...
    <div className="container mx-auto max-w-4xl px-4 py-8">
      ...
      <div className="prose prose-gray dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          ...
          <p>
            Permission is granted to temporarily download one copy of the materials (information or software) on our platform 
          ...
          <p className="mt-2">
            This license shall automatically terminate if you violate any of these restrictions and may be terminated by us 
        ...
        <section className="mb-8">
          ...
          <p>
            To use certain features of our service, you must register for an account. When you register for an account, 
            you agree to:
          </p>
          <ul className="list-disc ml-6 mt-2">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc ml-6 mt-2">
            <li>You agree to pay all fees or charges to your account based on our pricing and billing terms;</li>
            <li>You are responsible for providing valid payment information;</li>
            <li>You authorize us to charge your payment method for all fees;</li>
            <li>If payment is not received, we may suspend or terminate your access to the service.</li>
          </ul>
        </section>
        ...
        <section className="mb-8">
          ...
          <p>
            ...
            to use the materials on our platform, even if we or our authorized representative has been notified orally 
