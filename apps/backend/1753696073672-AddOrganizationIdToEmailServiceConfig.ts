...
export class AddOrganizationIdToEmailServiceConfig1753696073672 implements MigrationInterface {
    name = 'AddOrganizationIdToEmailServiceConfig1753696073672'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "email_service_configs" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "provider" "public"."email_service_configs_provider_enum" NOT NULL, "organizationId" uuid, "config" jsonb NOT NULL, "enabled" boolean NOT NULL DEFAULT false, "isDefault" boolean NOT NULL DEFAULT false, "isGlobalDefault" boolean NOT NULL DEFAULT false, "lastTestAt" TIMESTAMP, "lastTestSuccess" boolean, "lastTestError" text, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedBy" uuid, CONSTRAINT "PK_c473d7edc41377df8370e197200" PRIMARY KEY ("id"))`);
